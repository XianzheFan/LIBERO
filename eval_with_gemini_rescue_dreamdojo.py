...
def _rescue_select_action(
    ...
    for i in range(num_samples):
        arr = np.array(action_chunks[i][:replan_steps], dtype=np.float32)
        logging.info(
                ...
                try:
                    ...
                    if not action_plan:
                        ...
                        if rescue:
                            ...
                            step_save_dir = rollout_dir / "rescue_steps" / f"{task_segment}_ep{episode_idx}_frame{num_frames}_{_ts}"
