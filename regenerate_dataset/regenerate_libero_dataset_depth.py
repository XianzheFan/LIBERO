...
def get_libero_env(task, model_family, resolution=256):
    ...
    env_args = {"bddl_file_name": task_bddl_file, "camera_heights": resolution, "camera_widths": resolution, "camera_depths": [True] * len(camera_names)}
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for i in range(len(orig_data.keys())):
            ...
            for _, action in enumerate(orig_actions):
                ...
                if av_depth is None or eih_depth is None:
                ...
                eye_in_hand_depths.append(eih_depth)
